        ...
        <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-[60px]">
          ...
          <div className="min-h-[70vh] w-full">
                  ...
                  <ul className="grid gird-cols-1 lg:grid-cols-2 gap-[30px]">
                    {education.items.map((item, index) => {
                      return (
                        ...
                        >
                          <span className="text-accent">{item.duration}</span>
                          <PopOver contentStr={item.degree} />
                          <div className="flex items-center gap-3">
                            {/* dot */}
                            <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
            ...
            <TabsContent value="skills" className="w-full">
              <div className="flex flex-col gap-[30px] p">
                <div className="flex flex-col gap-[30px] text-center xl:text-left">
            ...
            {/* about */}
            {/*   
            <TabsContent value="about" className="w-full text-color xl:text-left">
...
const PopOver = ({ contentStr, overflowContentAt = 35 }) => {
  return (
